...
if (parametros$usar_arrow_para_validacion == "FALSE") {
  ...
  vals_09_educacion <- arrow::concat_tables(vals_ran_arrow,vals_asi_arrow) %>%
...
if (particion != "no") {
  path_dataset <- paste0(dir_out,"/09_educacion_estructural_particionado_",particion)
...
# arrow::write_csv_arrow(vals_09_educacion,file=paste0(ubi_out,"09_educacion_estructural.csv"))
